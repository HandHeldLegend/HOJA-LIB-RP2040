...
uint16_t                _rgb_anim_override_steps = 0;
...
{
    static uint8_t steps = 0xFF;
    float blend_step = 1.0f / _rgb_active_anim_steps;
    ...
    if (steps <= _rgb_active_anim_steps)
    {
