...
{
  _remap_profile.dpad_up    = array[MAPCODE_DUP];
  _remap_profile.dpad_down  = array[MAPCODE_DDOWN];
  _remap_profile.dpad_left  = array[MAPCODE_DLEFT];
  _remap_profile.dpad_right = array[MAPCODE_DRIGHT];
  _remap_profile.button_a   = array[MAPCODE_B_A];
  _remap_profile.button_b   = array[MAPCODE_B_B];
  _remap_profile.button_x   = array[MAPCODE_B_X];
  _remap_profile.button_y   = array[MAPCODE_B_Y];
  _remap_profile.trigger_l  = array[MAPCODE_T_L];
  _remap_profile.trigger_zl = array[MAPCODE_T_ZL];
  _remap_profile.trigger_r  = array[MAPCODE_T_R];
  _remap_profile.trigger_zr = array[MAPCODE_T_ZR];
  _remap_profile.button_plus        = array[MAPCODE_B_PLUS];
  _remap_profile.button_minus       = array[MAPCODE_B_MINUS];
  _remap_profile.button_stick_left  = array[MAPCODE_B_STICKL];
  _remap_profile.button_stick_right = array[MAPCODE_B_STICKR];
}

void _remap_unpack_remap(mapcode_t *array, button_remap_s *remap)
{
  array[MAPCODE_DUP]    = _remap_profile.dpad_up; 
  array[MAPCODE_DDOWN]  = _remap_profile.dpad_down;
  array[MAPCODE_DLEFT]  = _remap_profile.dpad_left;
  array[MAPCODE_DRIGHT] = _remap_profile.dpad_right;
  array[MAPCODE_B_A]    = _remap_profile.button_a;
  array[MAPCODE_B_B]    = _remap_profile.button_b;
  array[MAPCODE_B_X]    = _remap_profile.button_x;
  array[MAPCODE_B_Y]    = _remap_profile.button_y;
  array[MAPCODE_T_L]    = _remap_profile.trigger_l;
  array[MAPCODE_T_ZL]   = _remap_profile.trigger_zl;
  array[MAPCODE_T_R]    = _remap_profile.trigger_r;
  array[MAPCODE_T_ZR]   = _remap_profile.trigger_zr;
  array[MAPCODE_B_PLUS]   = _remap_profile.button_plus;
  array[MAPCODE_B_MINUS]  = _remap_profile.button_minus;    
  array[MAPCODE_B_STICKL] = _remap_profile.button_stick_left;
  array[MAPCODE_B_STICKR] = _remap_profile.button_stick_right;
}
